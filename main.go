...
//go:generate bash -c "mkdir -p codegen/message_bus && go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen@v1.12.4 -package message_bus https://raw.githubusercontent.com/Vioneta/VionetaOS-MessageBus/main/api/message_bus/openapi.yaml > codegen/message_bus/api.go"
package main
...
import (
	...
	"github.com/Vioneta/VionetaOS-UserService/codegen/message_bus"
	"github.com/Vioneta/VionetaOS-UserService/common"
	"github.com/Vioneta/VionetaOS-UserService/pkg/config"
	"github.com/Vioneta/VionetaOS-UserService/pkg/sqlite"
	"github.com/Vioneta/VionetaOS-UserService/pkg/utils/encryption"
	"github.com/Vioneta/VionetaOS-UserService/pkg/utils/random"
	"github.com/Vioneta/VionetaOS-UserService/route"
...
var (
	...
	//go:embed build/sysroot/etc/vionetaos/user-service.conf.sample
	_confSample string
)
